...
EXHIBIT_CATALOG = {
    ...
    "p1": {
        ...
        "column_spec": [
            ...
            {"field": "bsa_title", "header_patterns": ["Budget SubActivity (BSA) Title", "BSA Title",
                                                      "Budget Sub Activity (BSA) Title"], "dtype": "text",
             "description": "Budget Sub-Activity description"},
            {"field": "budget_line_item", "header_patterns": ["Budget Line Item", "Line Item"], "dtype": "text",
             "description": "Budget Line Item (BLI) code"},
            {"field": "bli_title", "header_patterns": ["Budget Line Item (BLI) Title",
                                                       "Program Element/Budget Line Item (BLI) Title",
                                                       "Line Item Title"], "dtype": "text",
            ...
            {"field": "add_non_add", "header_patterns": ["Add/Non-Add", "Add/ Non-Add"], "dtype": "text",
    ...
    "r1": {
        ...
        "column_spec": [
            ...
            {"field": "pe_bli", "header_patterns": ["PE/BLI", "PE / BLI", "PE"], "dtype": "text",
             "description": "Program Element / Budget Line Item code"},
            {"field": "pe_bli_title", "header_patterns": ["Program Element/Budget Line Item (BLI) Title",
                                                          "Program Element / Budget Line Item (BLI) Title",
                                                          "Program Element Title"], "dtype": "text",
    ...
    "o1": {
        ...
        "column_spec": [
            ...
            {"field": "budget_activity_title", "header_patterns": ["Budget Activity Title"], "dtype": "text",
             "description": "Budget Activity description"},
            {"field": "ag_bsa", "header_patterns": ["AG/BSA", "AG / BSA"], "dtype": "text",
             "description": "Activity Group / Budget Sub-Activity code"},
            {"field": "ag_bsa_title", "header_patterns": ["AG/Budget SubActivity (BSA) Title",
                                                          "AG / Budget SubActivity (BSA) Title",
                                                          "AG Title"], "dtype": "text",
             "description": "Activity Group / BSA description"},
            {"field": "line_number", "header_patterns": ["Line Number"], "dtype": "text",
             "description": "Line item number"},
            {"field": "sag_bli", "header_patterns": ["SAG/BLI", "SAG / BLI", "SAG"], "dtype": "text",
             "description": "Sub-Activity Group / Budget Line Item code"},
            {"field": "sag_bli_title", "header_patterns": ["SAG/Budget Line Item (BLI) Title",
                                                           "SAG / Budget Line Item (BLI) Title",
                                                           "SAG Title"], "dtype": "text",
