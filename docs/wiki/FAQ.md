...
<!-- Q: What unit are dollar amounts in?
     A: Thousands of dollars (canonical). The UI will support a toggle to millions.
     Q: What's the difference between PB, enacted, and request?
...
<!-- Q: Why are some rows showing zero amounts?
